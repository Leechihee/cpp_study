...
public:
    explicit bad_hmean(const std::string & s = "hmean() : 매개변수 오류!") : error(s) {}
};

class bad_gmean : public std::error{
public:
    explicit bad_gmean(const std::string & s = "gmean() : 매개변수 오류!") : error(s) {}
};
